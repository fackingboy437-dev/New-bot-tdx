...
const API_KEYS = ['csk-86em42vfvp9w2pkyfyj8mx96nxtdfy5pd59p3dnm3jpr2dh4'];
...
function getOwnerInfo(userID) {
  ...
  return {
    name: isMano ? 'MANO' : 'TAHA KHAN',
    gender: isMano ? 'girl' : 'boy'
  };
}

function getDisplayOwners() {
  let ownersList = '👑 **TAHA BOT OFFICIAL OWNERS** 👑\n\n';
...
Tu "bhai" word KABHI use nahi karti. "Boss", "Sir", "Malik", "taha my boss" use kar.
...
- Agar koi poochay "tera owner kaun?", "creator kaun?", "kisne banaya?", "tera malik?" = SIRF tab bolo "Mera creator TAHA KHAN hai, main uski creation hoon 💕"
- NORMAL baat mein TAHA KHAN ka naam mat le, sirf jab poochay tab
